  ...
  try {
    ...
    return NextResponse.json({
      ...
      report: {
        ...
        reportedItemTitle: (targetInfo as unknown)?.title || (targetInfo as unknown)?.name || report.targetId,
        reporterName: report.reporter.name,
        reporterEmail: report.reporter.email,
        targetUserName: (targetInfo as unknown)?.name || '알 수 없음',
        targetUserEmail: (targetInfo as unknown)?.email || '',

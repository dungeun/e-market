  ...
  try {
    ...
    try {
      ...
      const config = {
        header: {
          logo: {
            text: language === 'ko' ? 'E-Market Korea' : language === 'en' ? 'E-Market Korea' : 'E-Market Korea',
            imageUrl: null
          },
          menus: [
            { 
        ...
        footer: {
          ...
          copyright: language === 'ko' ? '© 2024 E-Market Korea. 모든 권리 보유.' : 
                    language === 'en' ? '© 2024 E-Market Korea. All rights reserved.' : 
                    '© 2024 E-Market Korea. 全著作権所有。'
        },
        mainPage: {
      ...
      const defaultConfig = {
        ...
        footer: {
          ...
          social: [],
          copyright: '© 2024 E-Market Korea. 모든 권리 보유.'
        },
        mainPage: {
    ...
    const fallbackConfig = {
      header: {
        logo: { text: 'E-Market Korea', imageUrl: null },
        menus: [
          { id: 'menu-1', label: '캠페인', href: '/campaigns', order: 1, visible: true }
        ],

...
export class AdminCache {
  ...
  static async setCampaignList(data: unknown, params: string): Promise<void> {
    try {
      if (!redis) return;
  ...
  static async setUserList(data: unknown, params: string): Promise<void> {
    try {
      if (!redis) return;
  ...
  static async setAnalytics(data: unknown, key: string): Promise<void> {
    try {
      if (!redis) return;

...
const useReactEffectEvent = (React as unknown)[' useEffectEvent '.trim().toString()];
const useReactInsertionEffect = (React as unknown)[' useInsertionEffect '.trim().toString()];

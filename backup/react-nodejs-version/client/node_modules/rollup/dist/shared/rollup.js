...
class MagicString {
	...
	insertLeft(index, content) {
		if (!warned.insertLeft) {
			 is deprecated. Use magicString.appendLeft(...) instead',
			);
	...
	insertRight(index, content) {
		if (!warned.insertRight) {
			 is deprecated. Use magicString.prependRight(...) instead',
			);
	...
	update(start, end, content, options) {
		...
		if (options === true) {
			if (!warned.storeName) {
				 should be an options object. See https://github.com/rich-harris/magic-string',
				);

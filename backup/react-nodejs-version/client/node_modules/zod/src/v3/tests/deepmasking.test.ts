...
//   const bad1 = () => fish.pick({ props: { unknown: true } } as unknown);
//   const bad2 = () => fish.omit({ name: true, props: { unknown: true } } as unknown);
...
//   const badcheck2 = () => f2.parse({ name: 'a', props: { color: 'b', numScales: 3 } } as unknown);
//   expect(badcheck2).toThrow();
// });
// test('f3', () => {
//   const f3 = fish.pick({ props: { color: true } });
//   f3.parse({ props: { color: 'b' } });
//   const badcheck3 = () => f3.parse({ name: 'a', props: { color: 'b', numScales: 3 } } as unknown);
...
//   const badcheck6 = () => f6.parse({ name: 'a', props: { color: 'b', numScales: 3 } } as unknown);
//   f6.parse({ name: 'adsf' });
...
//   const badcheck7 = () => f7.parse({ name: 'a', props: { color: 'b', numScales: 3 } } as unknown);
...
//   const bad1 = () => modFishArray.parse([{ name: 'fish', props: { numScales: 12, color: 'asdf' } }] as unknown);
//   expect(bad1).toThrow();
// });
...
//   const fail = () => modFishList.parse([{ name: 'hello', props: { numScales: 12 } }] as unknown);
//   expect(fail).toThrow();
// });

// test('primitive array masking', () => {
//   const fishArray = z.array(z.number());
//   const fail = () => fishArray.pick({} as unknown);
//   expect(fail).toThrow();
// });
...
// test('invalid mask #1', () => {
//   const fail = () => fish.pick(1 as unknown);
//   expect(fail).toThrow();
// });

// test('invalid mask #2', () => {
//   const fail = () => fish.pick([] as unknown);
//   expect(fail).toThrow();
// });

// test('invalid mask #3', () => {
//   const fail = () => fish.pick(false as unknown);
//   expect(fail).toThrow();
// });

// test('invalid mask #4', () => {
//   const fail = () => fish.pick('asdf' as unknown);
//   expect(fail).toThrow();
// });

// test('invalid mask #5', () => {
//   const fail = () => fish.omit(1 as unknown);
//   expect(fail).toThrow();
// });

// test('invalid mask #6', () => {
//   const fail = () => fish.omit([] as unknown);
//   expect(fail).toThrow();
// });

// test('invalid mask #7', () => {
//   const fail = () => fish.omit(false as unknown);
//   expect(fail).toThrow();
// });

// test('invalid mask #8', () => {
//   const fail = () => fish.omit('asdf' as unknown);
//   expect(fail).toThrow();
// });

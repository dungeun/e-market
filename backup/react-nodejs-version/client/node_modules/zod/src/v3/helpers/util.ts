export namespace util {
  ...
  export const getValidEnumValues = (obj: unknown): unknown[] => {
    const validKeys = objectKeys(obj).filter((k: unknown) => typeof obj[obj[k]] !== "number");
  ...
  export const objectValues = (obj: unknown): unknown[] => {
  ...
  export const objectKeys: ObjectConstructor["keys"] =
    typeof Object.keys === "function" // eslint-disable-line ban/ban
      ? (obj: unknown) => Object.keys(obj) // eslint-disable-line ban/ban
      : (object: unknown) => {
          const keys = [];

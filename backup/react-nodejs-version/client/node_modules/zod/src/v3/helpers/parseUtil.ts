...
export type ObjectPair = {
  key: SyncParseReturnType<unknown>;
  value: SyncParseReturnType<unknown>;
};
export class ParseStatus {
  ...
  static mergeArray(status: ParseStatus, results: SyncParseReturnType<unknown>[]): SyncParseReturnType {
  ...
  static async mergeObjectAsync(
    status: ParseStatus,
    pairs: { key: ParseReturnType<unknown>; value: ParseReturnType<unknown> }[]
  ): Promise<SyncParseReturnType<unknown>> {
...
export const isAborted = (x: ParseReturnType<unknown>): x is INVALID => (x as unknown).status === "aborted";
export const isDirty = <T>(x: ParseReturnType<T>): x is OK<T> | DIRTY<T> => (x as unknown).status === "dirty";
export const isValid = <T>(x: ParseReturnType<T>): x is OK<T> => (x as unknown).status === "valid";

...
export const quotelessJson = (obj: unknown) => {
...
export class ZodError<T = any> extends Error {
  ...
  constructor(issues: ZodIssue[]) {
    ...
    if (Object.setPrototypeOf) {
      ...
      (this as unknown).__proto__ = actualProto;
    }
    this.name = "ZodError";
    this.issues = issues;
  }
  ...
  flatten<U = string>(mapper: (issue: ZodIssue) => U = (issue: ZodIssue) => issue.message as unknown): any {

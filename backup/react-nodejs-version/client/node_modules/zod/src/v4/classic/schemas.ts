...
export const ZodType: core.$constructor<ZodType> = /*@__PURE__*/ core.$constructor("ZodType", (inst, def) => {
  ...
  inst.brand = () => inst as unknown;
  inst.register = ((reg: unknown, meta: unknown) => {
    reg.add(inst, meta);
    return inst;
  }) as unknown;
  ...
  inst.transform = (tx) => pipe(inst, transform(tx as unknown)) as never;
  ...
  inst.meta = (...args: unknown) => {
    if (args.length === 0) {
      return core.globalRegistry.get(inst);
    }
    const cl = inst.clone();
    core.globalRegistry.add(cl, args[0]);
    return cl as unknown;
  };
...
export const ZodString: core.$constructor<ZodString> = /*@__PURE__*/ core.$constructor("ZodString", (inst, def) => {
  ...
  // iso
  inst.datetime = (params) => inst.check(iso.datetime(params as unknown));
  inst.date = (params) => inst.check(iso.date(params as unknown));
  inst.time = (params) => inst.check(iso.time(params as unknown));
  inst.duration = (params) => inst.check(iso.duration(params as unknown));
});
...
export function string(params?: string | core.$ZodStringParams): ZodString {
  return core._string(ZodString, params) as unknown;
}
...
export function stringFormat<Format extends string>(
  ...
  return core._stringFormat(ZodCustomStringFormat, format, fnOrRegex, _params) as unknown;
}
...
export function number(params?: string | core.$ZodNumberParams): ZodNumber {
  return core._number(ZodNumber, params) as unknown;
}
...
export function boolean(params?: string | core.$ZodBooleanParams): ZodBoolean {
  return core._boolean(ZodBoolean, params) as unknown;
}
...
export function bigint(params?: string | core.$ZodBigIntParams): ZodBigInt {
  return core._bigint(ZodBigInt, params) as unknown;
}
// bigint formats
...
export const ZodArray: core.$constructor<ZodArray> = /*@__PURE__*/ core.$constructor("ZodArray", (inst, def) => {
  ...
  inst.element = def.element as unknown;
...
export function array<T extends core.SomeType>(element: T, params?: string | core.$ZodArrayParams): ZodArray<T> {
  return core._array(ZodArray, element as unknown, params) as unknown;
}

// .keyof
export function keyof<T extends ZodObject>(schema: T): ZodLiteral<Exclude<keyof T["_zod"]["output"], symbol>> {
  const shape = schema._zod.def.shape;
  return literal(Object.keys(shape)) as unknown;
}
...
export const ZodObject: core.$constructor<ZodObject> = /*@__PURE__*/ core.$constructor("ZodObject", (inst, def) => {
  ...
  inst.keyof = () => _enum(Object.keys(inst._zod.def.shape)) as unknown;
  inst.catchall = (catchall) => inst.clone({ ...inst._zod.def, catchall: catchall as unknown as core.$ZodType }) as unknown;
  ...
  inst.extend = (incoming: unknown) => {
    return util.extend(inst, incoming);
  };
  inst.merge = (other) => util.merge(inst, other);
  inst.pick = (mask) => util.pick(inst, mask);
  inst.omit = (mask) => util.omit(inst, mask);
  inst.partial = (...args: unknown[]) => util.partial(ZodOptional, inst, args[0] as object);
  inst.required = (...args: unknown[]) => util.required(ZodNonOptional, inst, args[0] as object);
});
...
export function object<T extends core.$ZodLooseShape = Partial<Record<never, core.SomeType>>>(
  ...
  return new ZodObject(def) as unknown;
}
...
export function union<const T extends readonly core.SomeType[]>(
  ...
  return new ZodUnion({
    type: "union",
    options: options as unknown as core.$ZodType[],
    ...util.normalizeParams(params),
  }) as unknown;
}
...
export function intersection<T extends core.SomeType, U extends core.SomeType>(
  ...
  return new ZodIntersection({
    type: "intersection",
    left: left as unknown as core.$ZodType,
    right: right as unknown as core.$ZodType,
  }) as unknown;
}
...
export const ZodTuple: core.$constructor<ZodTuple> = /*@__PURE__*/ core.$constructor("ZodTuple", (inst, def) => {
  ...
  inst.rest = (rest) =>
    inst.clone({
      ...inst._zod.def,
      rest: rest as unknown as core.$ZodType,
    }) as unknown;
});
...
export function tuple(
  ...
  return new ZodTuple({
    type: "tuple",
    items: items as unknown as core.$ZodType[],
    rest,
    ...util.normalizeParams(params),
  });
}
...
export function record<Key extends core.$ZodRecordKey, Value extends core.SomeType>(
  ...
  return new ZodRecord({
    type: "record",
    keyType,
    valueType: valueType as unknown as core.$ZodType,
    ...util.normalizeParams(params),
  }) as unknown;
}
...
export function partialRecord<Key extends core.$ZodRecordKey, Value extends core.SomeType>(
  ...
  return new ZodRecord({
    ...
    valueType: valueType as unknown,
    ...util.normalizeParams(params),
  }) as unknown;
}
...
export function map<Key extends core.SomeType, Value extends core.SomeType>(
  ...
  return new ZodMap({
    type: "map",
    keyType: keyType as unknown as core.$ZodType,
    valueType: valueType as unknown as core.$ZodType,
    ...util.normalizeParams(params),
  }) as unknown;
}
...
export const ZodEnum: core.$constructor<ZodEnum> = /*@__PURE__*/ core.$constructor("ZodEnum", (inst, def) => {
  ...
  inst.exclude = (values, params) => {
    const newEntries: Record<string, unknown> = { ...def.entries };
    for (const value of values) {
      if (keys.has(value)) {
...
function _enum(values: unknown, params?: string | core.$ZodEnumParams) {
  const entries: unknown = Array.isArray(values) ? Object.fromEntries(values.map((v) => [v, v])) : values;
...
export function literal(value: unknown, params: unknown) {
...
export function file(params?: string | core.$ZodFileParams): ZodFile {
  return core._file(ZodFile, params) as unknown;
}
...
export function optional<T extends core.SomeType>(innerType: T): ZodOptional<T> {
  return new ZodOptional({
    type: "optional",
    innerType: innerType as unknown as core.$ZodType,
  }) as unknown;
}
...
export function custom<O>(
  ...
  return core._custom(ZodCustom, fn ?? (() => true), _params) as unknown;
}
...
function _instanceof<T extends typeof util.Class>(
  ...
  const inst = new ZodCustom({
    ...
    abort: true,
    ...(util.normalizeParams(params) as unknown),
  });
...
export function preprocess<A, U extends core.SomeType, B = unknown>(
  ...
  return pipe(transform(fn as unknown), schema as unknown) as unknown;
}

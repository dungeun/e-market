...
test("checks", () => {
  const _a: z.core.$ZodCheck = {} as unknown as z.core.$ZodChecks;
  const _b: z.core.$ZodCheck = {} as unknown as z.core.$ZodStringFormatChecks;
  const _c: z.core.$ZodType = {} as unknown as z.core.$ZodTypes;
  const _d: z.core.$ZodType = {} as unknown as z.core.$ZodStringFormatTypes;
});

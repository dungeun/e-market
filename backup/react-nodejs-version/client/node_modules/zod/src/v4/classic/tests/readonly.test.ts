...
test("flat inference", () => {
  ...
  expectTypeOf<typeof readonlyAny._output>().toEqualTypeOf<unknown>();
...
//   expectTypeOf<z.infer<(typeof deepReadonlySchemas_0)[8]>>().toEqualTypeOf<unknown>();
//   expectTypeOf<
...
test("readonly and the get method", () => {
  ...
  expectTypeOf<z.infer<typeof readonlyAny>>().toEqualTypeOf<unknown>();

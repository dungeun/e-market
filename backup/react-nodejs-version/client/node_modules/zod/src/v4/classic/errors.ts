...
const initializer = (inst: ZodError, issues: core.$ZodIssue[]) => {
  ...
  Object.defineProperties(inst, {
    format: {
      value: (mapper: unknown) => core.formatError(inst, mapper),
      // enumerable: false,
    },
    flatten: {
      value: (mapper: unknown) => core.flattenError(inst, mapper),
      // enumerable: false,
    },
    addIssue: {
      value: (issue: unknown) => inst.issues.push(issue),
      // enumerable: false,
    },
    addIssues: {
      value: (issues: unknown) => inst.issues.push(...issues),
      // enumerable: false,
    },
    isEmpty: {
      get() {

...
export function _enum(Class: util.SchemaClass<schemas.$ZodEnum>, values: unknown, params?: string | $ZodEnumParams) {
...
export function _literal(Class: util.SchemaClass<schemas.$ZodLiteral>, value: unknown, params: unknown) {
  return new Class({
    type: "literal",
...
export function _catch<T extends schemas.$ZodObject>(
  ...
  return new Class({
    type: "catch",
    innerType,
    catchValue: (typeof catchValue === "function" ? catchValue : () => catchValue) as unknown,
  }) as unknown;
}

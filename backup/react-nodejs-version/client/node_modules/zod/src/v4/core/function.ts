...
> {
  ...
  (
    ...
    const impl = ((...args: unknown[]) => {
      ...
      const output = func(...(parsedArgs as unknown));
  ...
  implementAsync<F extends $InferInnerFunctionTypeAsync<Args, Returns>>(
    ...
    const impl = (async (...args: unknown[]) => {
      ...
      const output = await func(...(parsedArgs as unknown));
  ...
  input(...args: unknown[]): $ZodFunction<any, Returns> {
    const F: unknown = this.constructor;
...
function _function(params?: {
  ...
  return new $ZodFunction({
    ...
    input: Array.isArray(params?.input)
      ? _tuple(schemas.$ZodTuple, params?.input as unknown)

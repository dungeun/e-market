...
export const $ZodCheck: core.$constructor<$ZodCheck<unknown>> = /*@__PURE__*/ core.$constructor(
  "$ZodCheck",
  (inst, def) => {
    inst._zod ??= {} as unknown;
    inst._zod.def = def;
    inst._zod.onattach ??= [];
  }
);
...
export const $ZodCheckMaxSize: core.$constructor<$ZodCheckMaxSize> = /*@__PURE__*/ core.$constructor(
  ...
  (inst, def) => {
    ...
    inst._zod.def.when ??= (payload) => {
      ...
      return !util.nullish(val) && (val as unknown).size !== undefined;
    };
...
export const $ZodCheckMaxLength: core.$constructor<$ZodCheckMaxLength> = /*@__PURE__*/ core.$constructor(
  ...
  (inst, def) => {
    ...
    inst._zod.def.when ??= (payload) => {
      const val = payload.value;
      return !util.nullish(val) && (val as unknown).length !== undefined;
    };
  ...
  (inst, def) => {
    ...
    inst._zod.check = (payload) => {
      const result = def.schema._zod.run(
        {
          value: (payload.value as unknown)[def.property],
          issues: [],
        },
        {}
      );

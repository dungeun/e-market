...
export default function typeDetect(obj: unknown): string {
  ...
  if (typeof window === 'object' && window !== null) {
     ...
     */
    if (typeof (window as unknown).location === 'object' && obj === (window as unknown).location) {
      return 'Location';
    }
     ...
     */
    if (typeof (window as unknown).document === 'object' && obj === (window as unknown).document) {
      return 'Document';
    }

    if (typeof (window as unknown).navigator === 'object') {
      /* ! Spec Conformance
       ...
       */
      if (typeof (window as unknown).navigator.mimeTypes === 'object' &&
          obj === (window as unknown).navigator.mimeTypes) {
       ...
       */
      if (typeof (window as unknown).navigator.plugins === 'object' &&
          obj === (window as unknown).navigator.plugins) {
        return 'PluginArray';
      }
    }

    if ((typeof (window as unknown).HTMLElement === 'function' ||
        typeof (window as unknown).HTMLElement === 'object') &&
        obj instanceof (window as unknown).HTMLElement) {
      /* ! Spec Conformance
      * (https://html.spec.whatwg.org/multipage/webappapis.html#pluginarray)
      ...
      */
      if ((obj as unknown).tagName === 'BLOCKQUOTE') {
  ...
  */
  const stringTag = (symbolToStringTagExists && (obj as unknown)[Symbol.toStringTag]);

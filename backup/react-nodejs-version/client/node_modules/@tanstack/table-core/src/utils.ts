...
export function makeStateUpdater<K extends keyof TableState>(
  ...
  return (updater: Updater<TableState[K]>) => {
    ;(instance as unknown).setState(<TTableState>(old: TTableState) => {
      return {
        ...old,
        [key]: functionalUpdate(updater, (old as unknown)[key]),
      }
    })
  }
}
...
export function isFunction<T extends AnyFunction>(d: unknown): d is T {
...
export function getMemoOptions(
  tableOptions: Partial<TableOptionsResolved<unknown>>,
  debugLevel:
    | 'debugAll'
    | 'debugCells'
    | 'debugTable'

...
export type CustomAggregationFns = Record<string, AggregationFn<unknown>>
...
type ResolvedAggregationFns = keyof AggregationFns extends never
  ? {
      aggregationFns?: Record<string, AggregationFn<unknown>>
    }
  : {
      aggregationFns: Record<keyof AggregationFns, AggregationFn<unknown>>
    }
...
export const ColumnGrouping: TableFeature = {
  ...
  > => {
    return {
      aggregatedCell: props => (props.getValue() as unknown)?.toString?.() ?? null,
      aggregationFn: 'auto',
    }
  },

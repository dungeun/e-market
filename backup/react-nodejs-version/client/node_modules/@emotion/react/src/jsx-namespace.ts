...
type IsPreReact19 = 2 extends Parameters<React.FunctionComponent<unknown>>['length']
  ? true
  : false
...
// prettier-ignore
/** @ts-ignore */
type ReactJSXElementType = true extends IsPreReact19 ? string | React.JSXElementConstructor<unknown> : React.JSX.ElementType

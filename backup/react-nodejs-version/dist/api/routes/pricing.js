 ...
 */
router.post('/calculate-bulk', pricingController_1.pricingController.calculateBulkPricing);
/**
 ...
 * @body    { productId, quantity, userId?, customerGroup?, context? }
 */
router.post('/preview', pricingController_1.pricingController.previewPricing);
/**
 ...
 */
router.get('/rules/:ruleId', pricingController_1.pricingController.getPricingRule);
/**
 ...
 * @body    { name?, description?, type?, conditions?, discountType?, discountValue?, ... }
 */
router.put('/rules/:ruleId', pricingController_1.pricingController.updatePricingRule);
/**
 ...
 * @params  ruleId - Pricing rule ID
 */
router.delete('/rules/:ruleId', pricingController_1.pricingController.deletePricingRule);
/**
 ...
 * @body    { productId, quantity, userId?, customerGroup?, context? }
 */
router.post('/rules/:ruleId/test', pricingController_1.pricingController.testPricingRule);
/**

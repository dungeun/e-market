...
export function SectionsConfigTab() {
  ...
  const createDefaultSections = async () => {
    const defaultSections = [
      ...
      { key: 'active-campaigns', type: 'active-campaigns', title: '진행중인 캠페인', order: 7, isActive: true },
    ];
    ...
    for (const section of defaultSections) {
      try {
        ...
        console.error(`Failed to create section ${section.key}:`, error);
      }
    }

 ...
 */
export function standardizeCampaign(rawCampaign: any): StandardizedCampaign {
  return {
 ...
 */
export function standardizeCampaigns(rawCampaigns: any[]): StandardizedCampaign[] {
 ...
 */
export function standardizeCampaignForAPI(campaign: any) {

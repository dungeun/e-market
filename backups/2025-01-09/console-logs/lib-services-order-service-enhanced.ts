...
export class EnhancedOrderService {
  ...
  private async rollbackTransaction(transaction: OrderTransaction): Promise<void> {
    console.log(`Rolling back transaction for order ${transaction.orderId}`)

...
export default function RankingSectionEditPage() {
  ...
  const loadSection = async () => {
    try {
      ...
      const response = await fetch(`${apiUrl}/api/admin/homepage-sections?sectionId=ranking`, {
        credentials: "include"
      });
    ...
    try {
      ...
      const response = await fetch(`${apiUrl}/api/admin/homepage-sections`, {
        ...
        body: JSON.stringify({
          ...
          data: {
            title: {
              ko: rankingSection.title,
              en: rankingSection.title,
              jp: rankingSection.title,
            },
            subtitle: {
              ko: rankingSection.subtitle,
              en: rankingSection.subtitle,
              jp: rankingSection.subtitle,
            },
            sectionName: {
              ko: "인기 랭킹",
              en: "Popular Ranking",
